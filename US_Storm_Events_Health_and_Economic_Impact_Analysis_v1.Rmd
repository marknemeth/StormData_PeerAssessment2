...
evt_table_ante<-xtable(table(sort(analysisDF$event_type[analysisDF$begin_year<2007]))) #working on annual est.s later
evt_table_post<-xtable(table(sort(analysisDF$event_type[analysisDF$begin_year>2007]))) #working on annual est.s later

#dmg_table<-xtable(table(analysisDF$property_damage_scale[analysisDF$begin_year>2007]))

print(evt_table_ante, align="lr", include.colnames=TRUE, type="html")
print(evt_table_post, align="lr", include.colnames=TRUE, type="html")
```
